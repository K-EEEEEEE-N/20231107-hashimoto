    ...
    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
        <div class="page__result">
            <span class="font-medium">
                {!! __('全') !!}{{ $paginator->total() }}{!! __('件中') !!}
            </span>
            <span class="text__result-span text-sm text-gray-700 leading-5 page__result-item">
        ...
        <div class="select__page">
            <span class="select__page-first relative z-0 inline-flex shadow-sm rounded-md">
                {{-- Previous Page Link --}}
                @if ($paginator->onFirstPage())
                <span class='select__page-first' aria-disabled=" true" aria-label="{{ __('pagination.previous') }}">
